...
// == End: Boilerplate
		 ...
		 * @return string
		 */
		static function element_open( $str_ele = '', $arr_gats = '', $mix_validation = false ) {
		 ...
		 * @return string
		 */
		static function element_close( $str_ele = '', $arr_gats = '', $mix_validation = false ) {
		 ...
		 * @return string
		 */
		static function global_attrs( $arr = '' ) {
