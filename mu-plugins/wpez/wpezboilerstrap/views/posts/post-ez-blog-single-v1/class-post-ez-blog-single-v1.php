...
if ( ! class_exists('Post_EZ_Blog_Single_V1')) {
	class Post_EZ_Blog_Single_V1 extends \WPez\WPezBoilerStrap\Toolbox\Parents\View {
		...
		// print_r($mod);
			...
			// $str_ret .= $mac::ez_post_author_v1($mod, $vargs);

			$str_ret .= $mac::ez_post_category_v1($mod, $vargs);

			$str_ret .= $mac::ez_post_post_tag_v1($mod, $vargs);
			...
			$str_ret .= $mac::ez_post_post_excerpt_v1($mod, $vargs);

			$str_ret .= $mac::ez_post_read_more_v1($mod, $vargs);
